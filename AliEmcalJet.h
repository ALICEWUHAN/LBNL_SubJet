...
class AliEmcalJet : public AliVParticle
{
 public:
  ...
  // subjet functions++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  void              SetMotherIndex(Int_t index)                     { fMotherIndex=index                              ; }  
  Int_t             GetMotherIndex()                                { return fMotherIndex                             ; }
  void              SetNumberOfSubJets(Int_t n)                     { fSubJetIDs.Set(n)                               ; } 
  Int_t             GetNumberOfSubJets()                            { return fSubJetIDs.GetSize()                     ; }
  Int_t             SubJetAt(Int_t idx)                             { return fSubJetIDs.At(idx)                       ; }
  void              AddSubJetAt(Int_t jet, Int_t idx)               { fSubJetIDs.AddAt(jet, idx)                      ; }
   //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ 
 protected:
 ...
 //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  TArrayI           fSubJetIDs;                     //!  array to store the SubJets
  Int_t             fMotherIndex;                 //!  default -1  which used to set the mother index
 //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
